import { IconDownload, Row, Stack, Text } from 'moneyminder-mobile';
...
export const Colors = () => (
  <Stack gap="md" center>
    <Row gap="xl" center>
      <IconDownload size={28} color="#7C5CFF" />
      <IconDownload size={28} color="#626C77" />
      <IconDownload size={28} color="#E5484D" />
    </Row>
