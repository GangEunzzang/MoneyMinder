package com.moneyminder.auth.infrastructure.filter;

import com.moneyminder.auth.application.JwtProviderImpl;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        String accessToken = jwtProviderImpl.extractAccessToken(request)
                .orElseThrow(() -> new BaseException(ResultCode.JWT_NOT_FOUND));

        jwtProviderImpl.validateToken(accessToken);
