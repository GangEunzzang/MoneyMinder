import { IconUtensils, Row, Stack, Text } from 'moneyminder-mobile';
...
export const Colors = () => (
  <Stack gap="md" center>
    <Row gap="xl" center>
      <IconUtensils size={28} color="#7C5CFF" />
      <IconUtensils size={28} color="#626C77" />
      <IconUtensils size={28} color="#E5484D" />
    </Row>
