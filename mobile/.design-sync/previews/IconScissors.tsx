import { IconScissors, Row, Stack, Text } from 'moneyminder-mobile';
...
export const Colors = () => (
  <Stack gap="md" center>
    <Row gap="xl" center>
      <IconScissors size={28} color="#7C5CFF" />
      <IconScissors size={28} color="#626C77" />
      <IconScissors size={28} color="#E5484D" />
    </Row>
